ORDER_FIELDS = [
    ...
    {"name": "volume", "label": "Объем (м3)",
     "type": "number", "required": False},
    {"name": "from_city", "label": "Город отправления",
        "type": "text", "required": True},
    {"name": "to_city", "label": "Город назначения",
        "type": "text", "required": True},
    {"name": "date_from", "label": "Дата погрузки",
        "type": "date", "required": True},
    {"name": "date_to", "label": "Дата доставки",
